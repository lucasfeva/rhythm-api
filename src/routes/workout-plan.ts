...
export const workoutPlanRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      ...
      description:
        "Create a new workout plan with specified workout days and exercises",
      tags: ["Workout Plan"],
      response: {
  ...
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      ...
      description:
        "Start a workout session for a specific workout day within a workout plan. This will create a new workout session if one does not already exist for the day.",
      params: z.object({
